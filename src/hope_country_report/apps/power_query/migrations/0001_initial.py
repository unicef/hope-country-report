    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("template", models.CharField(blank=True, default=None, max_length=250, null=True)),
                ("datasource", models.CharField(blank=True, max_length=500, null=True)),
                ...
                (
                    "query",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="power_query.query"
                    ),
                ),
            ],
            options={
