...
CONFIG = {
    ...
    "BITCASTER_APPLICATION_SLUG": (str, "country-report"),
    "BITCASTER_BAE": (str, ""),
    ...
    "CACHE_URL": (str, "redis://localhost:6379/1", "Cache URL"),
    "CATCH_ALL_EMAIL": (str, ""),
    "CELERY_BROKER_URL": (str, "redis://localhost:6379/0", "Broker URL for Celery."),
    "CELERY_BOOST_FLOWER": (str, "/flower", "/flower", False, "https://unicef.github.io/django-celery-boost/"),
    ...
    "SENTRY_URL": (str, "https://monitoring.hope.unicef.org/organizations/hope/issues/?project=2", "Sentry server url"),
